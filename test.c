...
/*
  ...
  ft_printf("%d\n", ft_printf("11unsigneddd 1 %*12u unsigned 2 %*12u unsigned 3 %*12u\n", 42, -6, -42, 6, 12, 6));
  printf("%d\n\n", printf("11unsigneddd 1 %*12u unsigned 2 %*12u unsigned 3 %*12u\n\n", 42, -6, -42, 6, 12, 6));


  // Le %n n'est pas obigatoire. Il consiste a mettre le nombre de caracteres
  // affiches jusqu'a celui ci dans un pointeur sur int

  printf("J'affiche des %ncaracteres.\n", &n);
  printf("n = %d\n\n", n);
